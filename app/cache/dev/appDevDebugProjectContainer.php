...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'sardoni1_hbt', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'sardoni1', 'password' => 'gZSlvN91', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager51a4f4320c25f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager51a4f4320c25f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_diextra/doctrine/EntityManager_51a4f4320c25f.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_3e796115409031a49e50d1249a4a99c9');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_3e796115409031a49e50d1249a4a99c9');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_3e796115409031a49e50d1249a4a99c9');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home3/sardoni1/public_html/hbt.lesterlogic.com/src/LL/HBTBundle/Entity')), 'LL\\HBTBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('LLHBTBundle' => 'LL\\HBTBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51a4f4320c25f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($d, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $e), 'secured_area', $a, $this->get('event_dispatcher')), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '51a4f431d3d6f', $a), 3 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $d, $this->get('security.authentication.manager'), $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($c, $c), 'secured_area', NULL, NULL, NULL, $a));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home3/sardoni1/public_html/hbt.lesterlogic.com/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home3/sardoni1/public_html/hbt.lesterlogic.com/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home3/sardoni1/public_html/hbt.lesterlogic.com/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     *
     * @return EntityManager51a4f4320c25f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('51a4f431d3d6f')), true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home3/sardoni1/public_html/hbt.lesterlogic.com/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev',
            'kernel.logs_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/logs',
            'kernel.bundles' => array(
                ...
                'LLHBTBundle' => 'LL\\HBTBundle\\LLHBTBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'sardoni1_hbt',
            'database_user' => 'sardoni1',
            'database_password' => 'gZSlvN91',
            ...
            'debug.container.dump' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home3/sardoni1/public_html/hbt.lesterlogic.com/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/profiler',
            ...
            'router.resource' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/../web',
            'assetic.write_to' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_diextra/doctrine/EntityManager_51a4f4320c25f.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51a4f4320c25f_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/home3/sardoni1/public_html/hbt.lesterlogic.com/app/cache/dev/jms_security',
