...
class __TwigTemplate_8a6f24436450cfefed0e074c5eae7914 extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "\" width=\"22\" height=\"22\" alt=\"Add Entry\" />
            ...
            <div id=\"main-inner-body\">
                <div id=\"main-inner-body-header\">
                    ";
        // line 36
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["range"]) ? $context["range"] : null), "start"), "M. j, Y"), "html", null, true);
        echo " to ";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["range"]) ? $context["range"] : null), "end"), "M. j, Y"), "html", null, true);
        echo "
                    ";
        // line 37
        if ((twig_length_filter($this->env, (isset($context["entries"]) ? $context["entries"] : null)) > 0)) {
            // line 38
        ...
        if ((twig_length_filter($this->env, (isset($context["entries"]) ? $context["entries"] : null)) == 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                // line 55
                echo "                        ";
                $this->env->loadTemplate("LLHBTBundle:Default:entryRowHeader.html.twig")->display(array_merge($context, array("cat" => (isset($context["cat"]) ? $context["cat"] : null))));
                // line 56
                echo "                        ";
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["cat"]) ? $context["cat"] : null), "entries", array(), "array"));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["entry"]) {
                    // line 57
                    echo "                        \t";
                    $this->env->loadTemplate("LLHBTBundle:Default:entryRow.html.twig")->display(array_merge($context, array("entry" => (isset($context["entry"]) ? $context["entry"] : null))));
                    // line 59
                    echo "                        \t";
                    $context["total"] = ((isset($context["total"]) ? $context["total"] : null) + $this->getAttribute((isset($context["entry"]) ? $context["entry"] : null), "amount"));
                    // line 60
                    echo "                        ";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
                ...
                // line 61
                echo "                        ";
                $this->env->loadTemplate("LLHBTBundle:Default:entryRowSubtotal.html.twig")->display(array_merge($context, array("subtotal" => $this->getAttribute((isset($context["cat"]) ? $context["cat"] : null), "subtotal", array(), "array"))));
                // line 62
                echo "                    ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
    ...
    var dateStart = '";
        // line 75
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["range"]) ? $context["range"] : null), "start"), "Y-m-d"), "html", null, true);
        echo "';
    var dateEnd = '";
        // line 76
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["range"]) ? $context["range"] : null), "end"), "Y-m-d"), "html", null, true);
        echo "';
    var categories = [
        ";
        // line 78
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            // line 79
            echo "            {'label':'";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["cat"]) ? $context["cat"] : null), "label"), "html", null, true);
            echo "', 'category':'";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["cat"]) ? $context["cat"] : null), "category"), "html", null, true);
            echo "'},
